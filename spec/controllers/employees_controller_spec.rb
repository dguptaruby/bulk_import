...
RSpec.describe EmployeesController, :type => :controller do
  ...
  let(:params) { { "name" => "abc", "email" => "abc@gmail.com", "company_id" => company_create.id } }

  let(:invalid_attributes) { {
     "name" => "", "email" => "abc1@gmail.com", "company_id" => Company.first.id} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) { { "name" => "test", "email" => "abc@gmail.com", "company_id" => Company.first.id } }
